    ...
    <section id="garantia" className="border-b" style={{ padding: "clamp(56px,8vw,80px) 0", borderColor: "#e2ddd6", background: "#f7f4ef" }}>
      <div className="mx-auto w-full max-w-[720px] px-5 sm:px-6">
        ...
        <RevealDiv direction="rv">
          <div style={{ border: "1px solid rgba(212,130,10,.25)", borderRadius: 12, padding: "clamp(24px,5vw,40px)", background: "rgba(212,130,10,.03)", position: "relative", overflow: "hidden" }}>
            ...
            <h3 className="font-serif font-bold mb-4" style={{ fontSize: "clamp(20px,4vw,24px)", color: "#1a1612" }}>30 dias. Risco zero.</h3>
