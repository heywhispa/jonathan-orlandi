...
function PriceCounter() {
  ...
  useCounter(ref as React.RefObject<HTMLElement>, 97, "")
      ...
      <div className="mx-auto w-full max-w-[720px] px-5 sm:px-6">
        ...
        <div className="flex flex-col gap-5 mb-10">
          <RevealDiv direction="rv">
            <div className="transition-all duration-300" style={{ background: "#fff", border: "1px solid #e2ddd6", borderRadius: 12, padding: "clamp(24px,5vw,36px) clamp(20px,5vw,40px)" }}
            ...
            >
              <span className="inline-block font-bold uppercase tracking-wider mb-4" style={{ fontSize: 10, letterSpacing: ".12em", padding: "4px 10px", borderRadius: 100, background: "rgba(212,130,10,.1)", color: "#d4820a", border: "1px solid rgba(212,130,10,.25)" }}>Sistema</span>
          ...
          <RevealDiv direction="rv">
            <div className="transition-all duration-300" style={{ background: "rgba(212,130,10,.05)", border: "1px solid rgba(212,130,10,.2)", borderRadius: 12, padding: "clamp(24px,5vw,36px) clamp(20px,5vw,40px)" }}>
              <span className="inline-block font-bold uppercase tracking-wider mb-4" style={{ fontSize: 10, letterSpacing: ".12em", padding: "4px 10px", borderRadius: 100, background: "rgba(212,130,10,.06)", color: "#b86e08", border: "1px solid rgba(212,130,10,.15)" }}>+ Bônus</span>
        ...
        <RevealDiv direction="rv">
          <p className="font-serif font-bold uppercase tracking-wider mb-4" style={{ fontSize: 13, letterSpacing: ".12em", color: "#9a9088" }}>O que não tem preço mas vem junto</p>
        </RevealDiv>
        <ul className="flex flex-col gap-3 mb-10">
          {["Terminar o dia sem aquela culpa de ter travado de novo", "Parar de prometer pra você mesmo e começar a cumprir", "Saber que dessa vez você tem um sistema — não só força de vontade"].map((item, i) => (
            <RevealDiv key={i} direction="rv">
              <li className="flex items-center gap-4 font-normal transition-all duration-300" style={{ fontSize: "clamp(14px,2.5vw,16px)", color: "#5a5248", padding: "clamp(14px,3vw,20px) clamp(14px,3vw,24px)", background: i === 0 ? "rgba(212,130,10,.05)" : "#fff", border: `1px solid ${i === 0 ? "rgba(212,130,10,.18)" : "#e2ddd6"}`, borderRadius: 12, listStyle: "none" }}>
        ...
        <RevealDiv direction="rv">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4" style={{ padding: "clamp(20px,4vw,28px) clamp(20px,4vw,32px)", background: "#fff", border: "1px solid #e2ddd6", borderRadius: 12 }}>
            <div>
              <p className="font-light mb-4" style={{ fontSize: 15, color: "#5a5248", lineHeight: 1.6 }}>Você já investiu em tantas coisas que não agregaram na sua vida. Decida agora investir na sua melhor versão.</p>
              ...
              <div style={{ fontSize: 12, color: "#9a9088", marginTop: 4 }}>ou 12x de R$ 9,70</div>
            </div>
            <div className="text-center flex-shrink-0" style={{ background: "rgba(212,130,10,.1)", border: "1px solid rgba(212,130,10,.2)", borderRadius: 8, padding: "12px 16px", minWidth: 120 }}>
              ...
              <div className="font-serif font-extrabold" style={{ fontSize: "clamp(20px,4vw,22px)", color: "#d4820a" }}>R$ 230</div>
            </div>
          </div>
        </RevealDiv>
        ...
        <RevealDiv direction="rv">
          <a
            id="btn-checkout-v03b"
            href="https://checkout.pagtrust.com.br/ckce752f6a?funnel=fn0330a535"
            target="_blank"
          ...
          <p className="text-center font-light mt-3" style={{ fontSize: 13, color: "#9a9088" }}>Acesso imediato · Pagamento 100% seguro</p>
        </RevealDiv>
      </div>
      <style>{`
