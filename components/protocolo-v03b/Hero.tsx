...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute" style={{ top: -200, left: "50%", transform: "translateX(-50%)", width: "min(700px, 100vw)", height: "min(700px, 100vw)", background: "radial-gradient(circle, rgba(212,130,10,.07) 0%, transparent 65%)", animation: "glow 6s ease-in-out infinite alternate" }} />
      ...
      <div className="mx-auto w-full max-w-[720px] px-5 sm:px-6">
        ...
        <div>
          {/* Novo player Vturb v03b - with aspect-ratio to prevent CLS */}
          <div style={{ aspectRatio: "9 / 16", maxWidth: 400, width: "100%", margin: "0 auto", background: "#000", borderRadius: 12, overflow: "hidden", position: "relative" }}>
            ...
            <vturb-smartplayer id="vid-69d38fa5d48f269729692106" style={{ display: "block", width: "100%", height: "100%", opacity: playerLoaded ? 1 : 0 }} />
          </div>
