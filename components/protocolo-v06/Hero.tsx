  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[720px] px-5 sm:px-6">
        ...
        >
Um psicólogo que não conseguia controlar os próprios impulsos criou o protocolo que já tirou mais de{" "}
          <span style={{ color: "#d4820a", position: "relative" }} className="hero-underline">
            500 pessoas do piloto automático.
          </span>
        </h1>
        ...
        >
Ele tinha TDAH, vício em day trade e perdia horas no celular durante os próprios atendimentos. O que ele descobriu sobre dopamina mudou tudo — e não tem nada a ver com "cortar estímulos".
        </p>
