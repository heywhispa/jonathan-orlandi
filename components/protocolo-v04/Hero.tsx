    ...
    >
      ...
      <div className="mx-auto w-full max-w-[720px] px-5 sm:px-6">
        ...
        >
          ...
          é o motivo pelo qual você não consegue parar de procrastinar.
        </h1>
        ...
        >
          Um psicólogo com TDAH diagnosticado mostra o que realmente acontece no seu cérebro quando você tenta "ter disciplina" — e o protocolo de 4 fases que resolveu o problema dele (e de mais de 500 pessoas) em 30 dias.
        </p>
